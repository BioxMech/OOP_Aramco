...
public class ThailandPetroleumProductsNetExportScraperFirstCol {
    private String URL;
    private String rowName;

    public ThailandPetroleumProductsNetExportScraperFirstCol(String URL, String rowName) {
        this.URL = URL;
...
//                System.out.println("Ending Row: " + (startRow + rowsToCount));
                ...
                for (int i=0; i < rowsToCount ; i++) {
                    ...
                    if (rowsToRead.contains(cellTitle)) {
                        rowTitleCount++;
//                        System.out.println(rowTitleCount);
//                        System.out.println(colData.get(rowTitleCount));
//                        System.out.println();
